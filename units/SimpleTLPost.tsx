...
export default function SimpleTLPost({ post, isReply, hasReply, longReply, React, Embed }: UnitArgs["TLPost"]) {
	return (
		<div className="win-tomo-x-skycore-units-simpletlpost">
			<div className="left">
